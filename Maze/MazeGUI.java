...
public class MazeGUI extends JFrame
{
    ...
    public void exportTXT(){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(this, "Something went wrong with saving the file.\n" + e, "IOException", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void about(){
        JOptionPane.showMessageDialog(this, "A simple program that generates mazes using different algorithms.\n" + 
            "Warning dont generate large mazes in realtime!\n" + 
            "CS162 WOU\nBlake Bauer\nMay 6, 2016", "About", JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    private void initFrame(){
        ...
        gridBagConstraints = getConstraints(1,1,GridBagConstraints.HORIZONTAL,GridBagConstraints.SOUTHEAST,1.0,0.0);
        ...
        //Size JSpinner
        width = new JSpinner();
        gridBagConstraints = getConstraints(1,0,GridBagConstraints.HORIZONTAL,GridBagConstraints.NORTHWEST,0.4,0.0);
     ...
     */
    private GridBagConstraints getConstraints(int gridx, int gridy, int fill, int anchor, double weightx, double weighty){
