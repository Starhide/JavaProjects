...
public class Prims extends MazeAlgorithm
{
    ...
    public void generate(){
        ...
        while(vertices.size() < width*height){
            ...
            grid[((smallest.getSecond()%width)-(smallest.getFirst()%width))+(smallest.getFirst()%width)*2+1][((smallest.getSecond()/width)-(smallest.getFirst()/width))+(smallest.getFirst()/width)*2+1] = 0;
