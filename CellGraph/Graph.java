...
public class Graph
{
    ...
    public Iterable<Integer> adj(int v){
        ...
        //edges.stream().filter(p -> p.getX() == v).forEach(p -> adjacent.add(p.getY()));
        //edges.stream().filter(p -> p.getY() == v).forEach(p -> adjacent.add(p.getX()));
    ...
    public int degree(int v){
        ...
        //return (int) edges.stream().filter(p -> p.getY() == v || p.getX() == v).count();
    }
